...
ui_GP <- fluidPage(
  sidebarLayout(sidebarPanel(
    selectizeInput("Team", label = "Pick a Team", choices = LLGamePitching_df$School),
    selectizeInput("Stat", label = "Pick a Stat", choices = var_choices_GP)),
    mainPanel(plotlyOutput("scatterplot"))
  )
)

server_GP <- function(input, output, session) {
